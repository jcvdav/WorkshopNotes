...
loans <- filter(loans_all, keep == 1) %>% 
  mutate(outcome = ifelse(default == 1, "default", "repaid")) %>% 
  select(-c(1:3))
...
https://campus.datacamp.com/courses/supervised-learning-in-r-classification/chapter-4-classification-trees?ex=3
